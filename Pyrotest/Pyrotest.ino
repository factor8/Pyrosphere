...
#define SER_Pin2 10 //SER_IN
#define RCLK_Pin2 8 //L_CLOCK
#define SRCLK_Pin2 9 //CLOCK
...
Shifter shifter1(SER_Pin, RCLK_Pin, SRCLK_Pin, CHAIN1);
Shifter shifter2(SER_Pin2, RCLK_Pin2, SRCLK_Pin2, NUM_REGISTERS-CHAIN1); 
